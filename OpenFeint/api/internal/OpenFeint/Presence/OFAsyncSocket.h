 ...
 **/
- (void)onSocket:(OFAsyncSocket *)sock didAcceptNewSocket:(OFAsyncSocket *)newSocket;

/**
 * Called when a new socket is spawned to handle a connection.  This method should return the run-loop of the
 * thread on which the new socket and its delegate should operate. If omitted, [NSRunLoop currentRunLoop] is used.
 **/
- (NSRunLoop *)onSocket:(OFAsyncSocket *)sock wantsRunLoopForNewSocket:(OFAsyncSocket *)newSocket;
 ...
 **/
- (BOOL)onSocketWillConnect:(OFAsyncSocket *)sock;
 ...
 **/
- (void)onSocket:(OFAsyncSocket *)sock didReadPartialDataOfLength:(CFIndex)partialLength tag:(long)tag;
 ...
 **/
- (NSTimeInterval)onSocket:(OFAsyncSocket *)sock
...
@interface OFAsyncSocket : NSObject
{
