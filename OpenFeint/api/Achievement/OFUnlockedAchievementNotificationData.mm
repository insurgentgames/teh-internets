...
@synthesize unlockedAchievement;

+ (OFUnlockedAchievementNotificationData*) dataWithAchievement:(OFAchievement*)unlockedAchievement
{
	OFUnlockedAchievementNotificationData* data = [[OFUnlockedAchievementNotificationData new] autorelease];
	data.notificationText = @"Achievement Unlocked!";
